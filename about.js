...
gsap.set(".about-title", { y: 60, opacity: 0 });
gsap.set(".about-small-img", { scale: 0.7, opacity: 0 });
gsap.set(".about-feature", { y: 40, opacity: 0 });
gsap.set(".about-bottom", { y: 40, opacity: 0 });
gsap.set(".about-text", { y: 60, opacity: 0 });
gsap.set(".about-large-img", { scale: 0.7, opacity: 0 });
...
function runAboutAnimations() {
  ...
  tl.to(".about-label", { y: 0, opacity: 1, duration: 0.6 })
    .to(".about-title", { y: 0, opacity: 1, duration: 1 }, "-=0.3")
    .to(".about-small-img", { scale: 1, opacity: 1, duration: 1 }, "-=0.6")
    .to(
      ".about-feature",
      {
        y: 0,
    ...
    .to(".about-bottom", { y: 0, opacity: 1, duration: 0.8 }, "-=0.5");
  ...
  gsap.to(".about-large-img", {
    scrollTrigger: {
      trigger: ".about-large-img",
      start: "top 85%",
    },
    scale: 1,
    opacity: 1,
...
counters.forEach((counter) => {
  ...
  gsap.fromTo(
    ...
    { innerText: 0 },
    {
      ...
      onUpdate: function () {
        counter.innerText = Number(counter.innerText).toFixed(
          target % 1 !== 0 ? 1 : 0,
        );
      },
    },
...
const futureTimeline2 = gsap.timeline({
  scrollTrigger: {
    trigger: ".future-section2",
    start: "top 80%",
  },
});
...
const futureTimeline3 = gsap.timeline({
  scrollTrigger: {
    trigger: ".future-section3",
    start: "top 80%",
  },
});
