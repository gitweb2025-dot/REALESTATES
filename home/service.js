...
gsap.set(".service-image", { opacity: 0, x: -100 });
gsap.set(".services-label", { opacity: 0, y: 20 });
gsap.set(".services-title", { opacity: 0, y: 60 });
gsap.set(".services-desc", { opacity: 0, y: 30 });
...
function homeAnimation() {
  ...
  tl.to(".services-label", { y: 0, opacity: 1, duration: 0.5 })
    .to(".services-title", { y: 0, opacity: 1, duration: 1 }, "-=0.3")
    .to(".services-desc", { y: 0, opacity: 1, duration: 0.6 }, "-=0.7");
...
const rows = [".service-box:nth-child(-n+3)", ".service-box:nth-child(n+4)"];
