...
window.addEventListener("load", () => {
  ...
  gsap
    .timeline({
      delay: 2.3,
      onComplete: runLuxuryAnimations,
    })
    .to(loader, {
      opacity: 0,
      duration: 1.6,
...
gsap.set(".luxury-label", { opacity: 0, y: 20 });
gsap.set(".luxury-title", { opacity: 0, y: 80 });
gsap.set(".luxury-trust", { opacity: 0, y: 40 });
gsap.set(".luxury-row", { opacity: 0, y: 40 });

function runLuxuryAnimations() {
  ...
  tl.to(".luxury-label", { y: 0, opacity: 1, duration: 0.6 })
    .to(".luxury-title", { y: 0, opacity: 1, duration: 1 }, "-=0.3")
    .to(".luxury-trust", { y: 0, opacity: 1, duration: 0.8 }, "-=0.5");

  gsap.to(".luxury-row", {
    scrollTrigger: {
      trigger: ".luxury-right",
      start: "top 80%",
    },
    y: 0,
    opacity: 1,
...
tl.from(".choose-label", { y: 20, opacity: 0, duration: 0.6 })
  .from(".choose-title", { y: 60, opacity: 0, duration: 1 }, "-=0.3")
  .from(".choose-intro", { y: 40, opacity: 0, duration: 0.8 }, "-=0.5")
  .from(".choose-divider", {
    scaleX: 0,
...
t2.from(".services-label", { y: 20, opacity: 0, duration: 0.6 })
  ...
  .from(".services-intro", { y: 40, opacity: 0, duration: 0.8 }, "-=0.5");
