...
gsap.set(".homes-label", { opacity: 0, y: 20 });
gsap.set(".homes-title", { opacity: 0, y: 60 });
gsap.set(".home-item", { opacity: 0, y: 80 });

function runHomesAnimations() {
  const tl = gsap.timeline({
    scrollTrigger: {
      trigger: ".homes-section",
      start: "top 80%",
    },
  ...
  tl.to(".homes-label", { y: 0, opacity: 1, duration: 0.6 }).to(
    ".homes-title",
...
// hover effect
gsap.utils.toArray(".home-img").forEach((img) => {
